 ...
 */
public class CustomLoadingLayout extends AbstractLoadingLayout {
    ...
    public CustomLoadingLayout(Context context, PullToRefreshBase.Mode mode, PullToRefreshBase.Orientation scrollDirection, TypedArray attrs) {
        super(context, mode, scrollDirection, attrs,0,R.layout.custom_pull_to_refresh_header_vertical);
...
//		System.out.println("==============  releaseToRefreshImpl  ==============");
    ...
    protected int getDefaultDrawableResId() {
        return R.drawable.custom_loading;
    }
}
