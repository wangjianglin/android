...
//	}
	...
	public PullToRefreshHorizontalScrollView(Context context, AttributeSet attrs, Mode mode, Class<? extends LoadingLayout> loadingLayoutClass) {
		super(context,attrs, mode, loadingLayoutClass);
	}
