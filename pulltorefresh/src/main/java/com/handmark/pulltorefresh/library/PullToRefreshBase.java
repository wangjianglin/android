...
//	private AnimationStyle mLoadingAnimationStyle = AnimationStyle.getDefault();
	...
	private Class<? extends LoadingLayout> loadingLayoutClass;
...
//	}
	...
	public PullToRefreshBase(Context context, AttributeSet attrs, Mode mode, Class<? extends LoadingLayout> loadingLayoutClass) {
		super(context,attrs);
		mMode = mode;
//		mLoadingAnimationStyle = animStyle;
		this.loadingLayoutClass = loadingLayoutClass;
		init(context, attrs);
	}
...
//		mHeaderLayout = new NullLoadingLayout(this.getContext(), Mode.PULL_FROM_START, getPullToRefreshScrollDirection(), null);
//		mFooterLayout = new NullLoadingLayout(this.getContext(), Mode.PULL_FROM_END, getPullToRefreshScrollDirection(), null);
//		updateUIForMode();
//	}
...
//		return layout;
		try {
			Constructor<?> constructor = this.loadingLayoutClass.getConstructor(Context.class,Mode.class,Orientation.class,TypedArray.class);
			return (LoadingLayout) constructor.newInstance(context,mode,getPullToRefreshScrollDirection(),attrs);
		} catch (Throwable e) {
			e.printStackTrace();
		}
		return null;
...
//		else{
//			addViewInternal(new View(this.getContext()), 0, lp);
//		}
...
//		}
	...
	private void init(Context context, AttributeSet attrs) {
		if(loadingLayoutClass == null){
			loadingLayoutClass = RotateLoadingLayout.class;
		}
		switch (getPullToRefreshScrollDirection()) {
			case HORIZONTAL:
...
//		mHeaderLayout = new NullLoadingLayout(context, Mode.PULL_FROM_START, getPullToRefreshScrollDirection(), a);
//		mFooterLayout = new NullLoadingLayout(context, Mode.PULL_FROM_END, getPullToRefreshScrollDirection(), a);
