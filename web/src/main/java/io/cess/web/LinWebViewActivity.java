...
import io.cess.web.with.LinWebChromeClient;
import io.cess.web.with.LinWebView;
import io.cess.web.with.LinWebViewClient;
import io.cess.web.with.LinWebViewConsole;
import io.cess.web.x5.X5WebView;
...
public class LinWebViewActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.io_cess_web_view);
//		webView = new LinWebView(this);
		webView = (X5WebView) this.findViewById(R.id.io_cess_web_view_view);
		...
		scrollView = (ScrollView) this.findViewById(R.id.io_cess_web_view_scroll_view);
		textView = (TextView) this.findViewById(R.id.io_cess_web_view_text_view);
//		scrollView =
