...
public class WeixinHelper {
	...
	public boolean register(){
		...
		intent.putExtra("_mmessage_appPackage", "lin.buyers");
		intent.putExtra("_mmessage_content", "weixin://sendreq?appid="+APP_ID );
		intent.putExtra("_mmessage_checksum", a("weixin://sendreq?appid="+APP_ID, "lin.buyers"));
...
//            }
        Bitmap bmp = BitmapFactory.decodeResource(this.activity.getResources(), R.drawable.lin_web_weixin_link);
