...
public class CommandPackageManager {
    ...
    private static PackageManagerImpl<Integer,CommandRequestTcpPackage,CommandResponseTcpPackage> impl = new PackageManagerImpl<Integer,CommandRequestTcpPackage,CommandResponseTcpPackage>(new lin.util.Function<Integer,Class<?>>(){
