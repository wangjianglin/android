...
//}
	...
	private static HttpRequestListener globalListner =new HttpRequestListener(){
		...
		@Override
		public void request(HttpCommunicateImpl impl, lin.client.http2.HttpPackage pack) {
...
//	}
	...
	public static lin.client.http2.HttpCommunicateResult request(lin.client.http2.HttpPackage pack,ResultListener listener){
//		if(listener != null){
...
//	}
	...
	public static lin.client.http2.HttpCommunicateResult download(String file,
			ResultListener listener) {
		lin.client.http2.HttpCommunicateResult result = null;
		try {
			result = global.download(new URL(file), listener);
		} catch (MalformedURLException e) {

			//AutoResetEvent set = new AutoResetEvent();
			result = new lin.client.http2.HttpCommunicateResult();
			//result.set = set;
			if(listener != null){
				listener.fault(new lin.client.http2.Error());
			}
	...
	public static lin.client.http2.HttpCommunicateResult download(URL file,
			ResultListener listener) {
