...
import lin.client.http2.*;
import lin.client.http2.Aboutable;
import lin.client.http2.Error;
import lin.client.http2.FileInfo;
import lin.client.http2.ProgressResultListener;
import lin.util.Utils;

/**
 * Created by lin on 9/24/15.
 */
class DownloadFile implements lin.client.http2.Aboutable {
