...
import lin.client.http2.annotation.HttpFileInfo;
import lin.client.http2.annotation.HttpPackageMethod;
import lin.client.http2.annotation.HttpPackageReturnType;
import lin.client.http2.annotation.HttpPackageUrl;
import lin.client.http2.annotation.HttpParamName;
