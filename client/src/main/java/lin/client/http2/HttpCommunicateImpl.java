...
public class HttpCommunicateImpl{// implements HttpCommunicate{
	...
	//HttpCommunicateImpl(){}
	HttpCommunicateImpl(String name, lin.client.http2.HttpCommunicate c) {
		if(c == null){
...
//		}
	...
	private void fireRequestResultListener(lin.client.http2.HttpPackage pack,Object obj, List<lin.client.http2.Error> warning){
		for(SoftReference<HttpRequestListener> item : listeners){
			if(item.get() != null){
	...
	private void fireRequestFaultListener(lin.client.http2.HttpPackage pack, lin.client.http2.Error error){
		for(SoftReference<HttpRequestListener> item : listeners){
			if(item.get() != null){
	...
	private void fireRequestListener(lin.client.http2.HttpPackage pack){
		for(SoftReference<HttpRequestListener> item : listeners){
			if(item.get() != null){
...
//	public HttpCommunicateResult request(lin.client.http.Package pack,final ResultFunction result,final FaultFunction fault){
	public lin.client.http2.HttpCommunicateResult request(final lin.client.http2.HttpPackage pack,final ResultListener listener){

		this.fireRequestListener(pack);

		final lin.client.http2.HttpCommunicateResult httpHesult = new lin.client.http2.HttpCommunicateResult();
//		final AutoResetEvent set = new AutoResetEvent(false);
		HttpRequest request = new HttpRequest(this,pack, new ResultListener() {

			@Override
				public void result(final Object obj, final List<lin.client.http2.Error> warning) {
...
//			}
			...
			@Override
			public void fault(final lin.client.http2.Error error) {
				lin.util.thread.ActionExecute.execute(new Action() {
					@Override
					public void action() {
...
//		httpHesult.set = set;
	...
	private boolean fireResult(final lin.client.http2.HttpCommunicateResult httpResult,final ResultListener listener,final Object obj,final List<lin.client.http2.Error> warning){
			if(listener != null){
...
//			}
//		}
	private void fireFault(final lin.client.http2.HttpCommunicateResult httpResult,final ResultListener listener,final lin.client.http2.Error error){
		if(listener != null){
			if(this.mainThread && httpResult.threadId != mHandler.getLooper().getThread().getId()){
				mHandler.post(new Runnable(){
	...
	private void fireProgress(final lin.client.http2.HttpCommunicateResult httpResult,final lin.client.http2.ProgressResultListener listener,final long progress,final long total){
		if(listener != null){
...
//	}
	...
	public lin.client.http2.HttpCommunicateResult download(String file, final ResultListener listener){

		return  null;
	}

	public lin.client.http2.HttpCommunicateResult download(URL file,final ResultListener listener){
		lin.client.http2.ProgressResultListener pListener = null;
		if(listener instanceof lin.client.http2.ProgressResultListener) {
			pListener = (lin.client.http2.ProgressResultListener) listener;
		}

		final lin.client.http2.HttpCommunicateResult httpHesult = new lin.client.http2.HttpCommunicateResult();
//		final AutoResetEvent set = new AutoResetEvent(false);
//		httpHesult.set = set;
		final lin.client.http2.ProgressResultListener finalPListener = pListener;
		fireRequestListener(null);
		DownloadFile downloadFile = new DownloadFile(new lin.client.http2.ProgressResultListener(){
