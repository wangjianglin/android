...
import io.cess.core.recyclerview.RecyclerItemClickListener;
import io.cess.core.recyclerview.headers.StickyHeadersAdapter;
import io.cess.core.recyclerview.headers.StickyHeadersDecoration;
import io.cess.core.recyclerview.headers.StickyHeadersTouchListener;
import io.cess.demo.R;
import io.cess.demo.databinding.ActivityMainHeaderBinding;
                ...
                if(obj instanceof Intent){
                    ...
                    if(Activity.class.isAssignableFrom(cls)) {
                        MainFragment.this.startActivity(new Intent(MainFragment.this.getContext(), (Class<?>) obj));
                            ...
                            io.cess.core.ContentView.class.isAssignableFrom(cls) ||
                            io.cess.core.ViewHolder.class.isAssignableFrom(cls)){
