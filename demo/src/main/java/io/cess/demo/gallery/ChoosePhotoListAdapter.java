...
//                .showImageOnFailnLoading(R.drawable.ic_gf_default_photo)
                .build();

        ImageView ivPhoto = (ImageView) mInflater.inflate(R.layout.activity_gallery_adapter_photo_list_item, null);
        setHeight(ivPhoto);
