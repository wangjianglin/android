...
package io.cess.core.gallery.adapter;
...
import io.cess.core.gallery.widget.GFImageView;
...
public class FolderListAdapter extends ViewHolderAdapter<FolderListAdapter.FolderViewHolder, PhotoFolderInfo> {
    ...
    public FolderViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflate(R.layout.io_cess_core_gallery_adapter_folder_list_item, parent);
    ...
    public void onBindViewHolder(FolderViewHolder holder, int position) {
        ...
        holder.mTvPhotoCount.setText(mActivity.getString(R.string.io_cess_core_grallery_folder_photo_size, size));
