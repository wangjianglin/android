...
package io.cess.core.gallery.widget.crop;
...
import io.cess.core.gallery.FilenameUtils;
import io.cess.core.gallery.GalleryFinal;
import io.cess.core.gallery.PhotoBaseFragment;

/*
 * Modified from original in AOSP.
 */
public abstract class CropImageFragment extends MonitoredFragment {
...
//        }
    ...
    public void setSourceUri(Uri sourceUri) {
        ...
        if (sourceUri != null) {
            exifRotation = CropUtil.getExifRotation(CropUtil.getFromMediaUri(this.getContext(), this.getContext().getContentResolver(), sourceUri));

            InputStream is = null;
            try {
                sampleSize = calculateBitmapSampleSize(sourceUri);
                is = this.getContext().getContentResolver().openInputStream(sourceUri);
...
//                setCropSaveException(e);
    ...
    private void saveImage(Bitmap croppedImage, final File saveFile) {
        if (croppedImage != null) {
            ...
            CropUtil.startBackgroundJob(this, null, getResources().getString(R.string.io_cess_core_grallery_saving),
                    new Runnable() {
                        public void run() {
    ...
    private void saveOutput(Bitmap croppedImage, File saveFile) {
        if (saveFile != null) {
            ...
            CropUtil.copyExifRotation(
                    CropUtil.getFromMediaUri(this.getContext(), this.getContext().getContentResolver(), sourceUri),
                    CropUtil.getFromMediaUri(this.getContext(), this.getContext().getContentResolver(), Uri.fromFile(saveFile))
            );
