...
package io.cess.core.gallery.widget;
...
//        attr.recycle();
        ...
        updateCircleSize();
        mShadowRadius = getDimension(R.dimen.io_cess_core_grallery_fab_shadow_radius);
        mShadowOffset = getDimension(R.dimen.io_cess_core_grallery_fab_shadow_offset);
        updateDrawableSize();
    ...
    private void updateCircleSize() {
        mCircleSize = getDimension(R.dimen.io_cess_core_grallery_fab_size_normal);
    }
    ...
    public void setTitle(String title) {
        mTitle = title;
        TextView label = (TextView) getTag(R.id.io_cess_core_grallery_fab_label);
        if (label != null)
            label.setText(title);
    }
    ...
    void updateBackground() {
        ...
        float iconOffset = (mCircleSize - getDimension(R.dimen.io_cess_core_grallery_fab_icon_size)) / 2f;
