...
//            super.setContentViewById(R.layout.io_cess_core_tools_act);
//            Toolbar toolbar = (Toolbar)this.findViewById(R.id.io_cess_core_tools_act_toolbar);
...
//        transaction.replace(R.id.io_cess_core_tools_act_layout, new ViewFragment(view));
////        } else {
