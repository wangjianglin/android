...
import io.cess.core.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.io_cess_core_wheel_bg;
	private int wheelForeground = R.drawable.io_cess_core_wheel_val;
