 ...
 */
@ResCls(R.class)
@ResId(id="io_cess_core_form_section")
public class Section extends ResView {
	...
	@ViewById(id="io_cess_core_form_section_container")
	private LinearLayout containerView;


	@ViewById(id="io_cess_core_form_section_header")
	private ViewGroup headerView;

	@ViewById(id="io_cess_core_form_section_footer")
	private ViewGroup footerView;


	@ViewById(id="io_cess_core_form_section_header_text")
	private TextView headerTextView;

	@ViewById(id="io_cess_core_form_section_footer_text")
