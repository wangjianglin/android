package io.cess.core.recyclerview.headers;
...
import io.cess.core.recyclerview.headers.caching.HeaderProvider;
import io.cess.core.recyclerview.headers.caching.HeaderViewCache;
import io.cess.core.recyclerview.headers.calculation.DimensionCalculator;
import io.cess.core.recyclerview.headers.rendering.HeaderRenderer;
import io.cess.core.recyclerview.headers.util.LinearLayoutOrientationProvider;
import io.cess.core.recyclerview.headers.util.OrientationProvider;
...
public class StickyHeadersDecoration extends RecyclerView.ItemDecoration {
  ...
  public StickyHeadersDecoration(StickyHeadersAdapter adapter, ItemVisibilityAdapter visibilityAdapter) {
