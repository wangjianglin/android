...
public class TabBar extends ResView {
	...
	@ViewById(id = "io_cess_core_tabbar_bar_layout")
...
//	private List<android.support.v4.app.Fragment> tabItems = new ArrayList<android.support.v4.app.Fragment>();
	...
	private void initWithTheme() {
		int r = this.getAttrs().getInt(R.styleable.io_cess, R.styleable.io_cess_view_theme);
		if (r == 0) {
			r = R.layout.io_cess_core_tabbar_main;
		}
		this.init(r);
	}
	...
	protected void addViewItem(View item, int index, ViewGroup.LayoutParams params) {
		...
		if (tabbarItemId == 0) {
			tabbarItemId = R.layout.io_cess_core_tabbar_item_bar;
		}
		...
		if (tabIndex >= 0 && tabIndex < tabs.size()) {
			...
			if (isSupportAppCompat()) {
				...
				if(tabItems.get(tabIndex).isAdd){
					...
					transaction.add(R.id.io_cess_core_tabbar_content, tabItems.get(tabIndex).fragment);
	...
	protected void genAttrs() {
		...
		this.addAttr(R.styleable.io_cess, R.styleable.io_cess_view_theme, AttrType.Int);
	}
	...
	protected void genLayoutAttrs() {
		...
		this.addLayoutAttr(R.styleable.io_cess, R.styleable.io_cess_view_theme, AttrType.Int);
	}

	public static class ClickItem extends android.view.View {
...
//		int r = this.getAttrs().getInteger(R.styleable.io_cess_view_theme);
//		if(r == 0){
...
//
//
//		background = attrs.getDrawable(R.styleable.io_cess_tab_background);
//		if(background == null){
//			background = super.getBackground();
//		}
//		activateBackground = attrs.getDrawable(R.styleable.io_cess_tab_activate_background);
//
//		if(background != null){
//			super.setBackground(background);
//		}
//
//		overlayDrawable = attrs.getDrawable(R.styleable.io_cess_tab_overlay);
////
//	}
//
//	@Override
//	protected void addViewItem(View item){
//		int tabbarItemId = this.getAttrs().getInteger(R.styleable.io_cess_tab_item_theme);
//		if(tabbarItemId == 0){
...
////			text.setText(barItem.getAttrs().getString(R.styleable.io_cess_tab_name));
////			if(barItem.getAttrs().getDrawable(R.styleable.io_cess_tab_icon) != null){
////				ImageView image = (ImageView) barView.findViewById(R.id.tabbar_tiem_bar_img_id);
////				image.setImageDrawable(barItem.getAttrs().getDrawable(R.styleable.io_cess_tab_icon));
////			}
////		}
