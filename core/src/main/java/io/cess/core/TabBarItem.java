...
//		Attrs attrs = ((LayoutParams) this.contentView.getLayoutParams()).getAttrs();
	...
	@ViewById(id="io_cess_core_tabbar_tiem_bar_text_id")
	private TextView text;// = (TextView) barView.findViewById(R.id.tabbar_tiem_bar_text_id);
	
	@ViewById(id="io_cess_core_tabbar_tiem_bar_overlay_view_id")
	private View overlayView;
	
	@ViewById(id="io_cess_core_tabbar_tiem_bar_img_id")
