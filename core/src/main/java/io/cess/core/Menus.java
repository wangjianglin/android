...
public class Menus {
    ...
    private static void onCreateOptionsMenuImpl(Object holder,Context context,Menu menu, MenuInflater inflater,int menuId) {
        ...
        io.cess.core.annotation.MenuId menuAnnot = holder.getClass().getAnnotation(io.cess.core.annotation.MenuId.class);
        ...
        for(Method m : ms){
            menuAnnot = m.getAnnotation(io.cess.core.annotation.MenuId.class);
            if(menuAnnot == null){
                continue;
            }
...
//    private static Map<Integer,Method> menuItemMaps = new HashMap<>();
    ...
    private static void processMethodMenuAnnot(Class<?> cls, Context context,Map<Integer,Method> map,Method method,io.cess.core.annotation.MenuId menuAnnot,Menu menu, MenuInflater inflater){
    ...
    private static void processClsMenuAnnot(Class<?> cls, Context context,io.cess.core.annotation.MenuId menuAnnot,Menu menu, MenuInflater inflater){
    ...
    private static int[] menuAnnotIds(Class<?> cls, Context context,io.cess.core.annotation.MenuId menuAnnot, String clsSuff){
