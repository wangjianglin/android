...
//		super(context);
//		this.argsId = argsId;
//		themeId = R.layout.io_cess_core_nav_main;
...
//		themeId = this.getAttrs().getInt(R.styleable.lin,R.styleable.io_cess_view_theme);
//		if(themeId == 0){
//			themeId = R.layout.io_cess_core_nav_main;
//		}
//		this.init(themeId);
...
////				if(!isSetTitle){
////					titleTextView.setText(itemView.getAttrs().getString(R.styleable.io_cess_nav_title));
////				}
////
////				Drawable background = itemView.getAttrs().getDrawable(R.styleable.io_cess_nav_background);
////				if(!isSetShow){
////					this.showTitleImpl(itemView.getAttrs().getBoolean(R.styleable.io_cess_nav_show_title, this.isShow));
////				}
////				if(background != null){
...
//				transaction.replace(R.id.io_cess_core_nav_content_frame, new ViewFragment((View) item));
//			}else{
//				transaction.replace(R.id.io_cess_core_nav_content_frame, (Fragment) item);
//			}
//			transaction.commit();
//		}
//	}
...
////			return;
////		}
////		View buttonView = LayoutInflater.from(this.getContext()).inflate(R.layout.io_cess_core_navigation_botton, parent, true);
