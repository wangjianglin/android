...
import lin.core.annotation.Attr;
...
//	values.put(ids[id]+"",attrArray.getDimensionPixelSize(id,0));
	...
	void addAttr(Object holder) {
		lin.core.annotation.Attrs attrsAnnon = holder.getClass().getAnnotation(lin.core.annotation.Attrs.class);
	...
	void addLayoutAttr(Object holder) {
		...
		lin.core.annotation.LayoutAttrs attrsAnnon = holder.getClass().getAnnotation(lin.core.annotation.LayoutAttrs.class);
...
//		}
//
//		lin.core.annotation.Attrs attrsAnnon = this.getClass().getAnnotation(lin.core.annotation.Attrs.class);
//
//
//		if (attrsAnnon != null) {
...
//			values.put("id:"+R.styleable.lin_view_theme, theme);
//			values.put("name:lin_view_theme", theme);
//		}
//
//		//nav相关 开始
//		values.put("id:"+R.styleable.lin_nav_background, attrArray.getDrawable(R.styleable.lin_nav_background));
//		values.put("name:lin_nav_background", attrArray.getDrawable(R.styleable.lin_nav_background));
//
//		values.put("id:"+R.styleable.lin_nav_title, attrArray.getString(R.styleable.lin_nav_title));
//		values.put("name:lin_nav_title", attrArray.getString(R.styleable.lin_nav_title));
//
//		values.put("id:"+R.styleable.lin_nav_title_color, attrArray.getString(R.styleable.lin_nav_title_color));
//		values.put("name:lin_nav_title_color", attrArray.getString(R.styleable.lin_nav_title_color));
//
//		values.put("id:"+R.styleable.lin_nav_show_title, attrArray.getBoolean(R.styleable.lin_nav_show_title,true));
//		values.put("name:lin_nav_show_title", attrArray.getBoolean(R.styleable.lin_nav_show_title,true));
//
////		if(attrArray.hasValue(R.styleable.lin_nav_background_color)){
////			values.put("id:"+R.styleable.lin_nav_background_color, attrArray.getColor(R.styleable.lin_nav_background_color,0xffffff));
////			values.put("name:lin_nav_background_color", attrArray.getColor(R.styleable.lin_nav_background_color,0xffffff));
////		}
//
//		values.put("id:"+R.styleable.lin_nav_tag, attrArray.getString(R.styleable.lin_nav_tag));
//		values.put("name:lin_nav_tag", attrArray.getString(R.styleable.lin_nav_tag));
//		//nav相关 结束
//
//		//tab相关 开始
//		values.put("id:"+R.styleable.lin_tab_icon, attrArray.getDrawable(R.styleable.lin_tab_icon));
//		values.put("name:lin_tab_icon", attrArray.getDrawable(R.styleable.lin_tab_icon));
//
//		values.put("id:"+R.styleable.lin_tab_activate_icon, attrArray.getDrawable(R.styleable.lin_tab_activate_icon));
//		values.put("name:lin_tab_activate_icon", attrArray.getDrawable(R.styleable.lin_tab_activate_icon));
//
//		values.put("id:"+R.styleable.lin_tab_background, attrArray.getDrawable(R.styleable.lin_tab_background));
//		values.put("name:lin_tab_background", attrArray.getDrawable(R.styleable.lin_tab_background));
//
//		values.put("id:"+R.styleable.lin_tab_activate_background, attrArray.getDrawable(R.styleable.lin_tab_activate_background));
//		values.put("name:lin_tab_activate_background", attrArray.getDrawable(R.styleable.lin_tab_activate_background));
//
//		values.put("id:"+R.styleable.lin_tab_name, attrArray.getString(R.styleable.lin_tab_name));
//		values.put("name:lin_tab_name", attrArray.getString(R.styleable.lin_tab_name));
//
//		if(attrArray.hasValue(R.styleable.lin_tab_item_theme)){
//			values.put("id:"+R.styleable.lin_tab_item_theme, attrArray.getResourceId(R.styleable.lin_tab_item_theme,0));
//			values.put("name:lin_tab_item_theme", attrArray.getResourceId(R.styleable.lin_tab_item_theme,0));
//		}
//
//		values.put("id:"+R.styleable.lin_tab_overlay, attrArray.getDrawable(R.styleable.lin_tab_overlay));
//		values.put("name:lin_tab_overlay", attrArray.getDrawable(R.styleable.lin_tab_overlay));
//
//		//tab相关 结束
////		values.put("name:lin_tab_theme", attrArray.getInteger(R.styleable.lin_nav_theme,0));
////		values.put("id:"+R.styleable.lin_tab_theme, attrArray.getInteger(R.styleable.lin_nav_theme,0));
//
//
//		//form 相关  开始
//		values.put("id:"+R.styleable.lin_form_row_text, attrArray.getString(R.styleable.lin_form_row_text));
//		values.put("name:lin_form_row_text", attrArray.getString(R.styleable.lin_form_row_text));
////
//		values.put("id:"+R.styleable.lin_form_row_title, attrArray.getString(R.styleable.lin_form_row_title));
//		values.put("name:lin_form_row_title", attrArray.getString(R.styleable.lin_form_row_title));
//
////		if(attrArray.hasValue(R.styleable.lin_form_row_accessory)){
////			values.put("id:"+R.styleable.lin_form_row_accessory, attrArray.getBoolean(R.styleable.lin_form_row_accessory,false));
////		}else{
////			values.put("id:"+R.styleable.lin_form_row_accessory, null);
////		}
////		if(attrArray.hasValue(R.styleable.lin_form_row_accessory)){
////			values.put("name:lin_form_row_accessory", attrArray.getBoolean(R.styleable.lin_form_row_accessory,false));
////		}else{
////			values.put("name:lin_form_row_accessory", null);
////		}
//		if(attrArray.hasValue(R.styleable.lin_form_row_accessory)){
//			values.put("id:"+R.styleable.lin_form_row_accessory, attrArray.getBoolean(R.styleable.lin_form_row_accessory,false));
//			values.put("name:lin_form_row_accessory", attrArray.getBoolean(R.styleable.lin_form_row_accessory,false));
...
////		attrArray.
////		values.put("name:lin_form_row_accessory", attrArray.getString(R.styleable.lin_form_row_accessory));
////		attrArray.
//		attrArray.recycle();
//	}
