...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        boolean r = this.onInterceptTouchEventImpl(ev);
        System.out.println("onInterceptTouchEvent:"+r);
        return r;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        boolean r = this.onTouchEventImpl(ev);
        System.out.println("onTouchEvent:"+r);
        return r;
    }

    private boolean onTouchEventImpl(MotionEvent ev){
        final int action = MotionEventCompat.getActionMasked(ev);
