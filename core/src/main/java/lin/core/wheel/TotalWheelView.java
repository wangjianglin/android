...
import lin.core.wheel.adapters.ArrayWheelAdapter;

/**
 * Created by Administrator on 2017/6/8.
 */
@ResCls(R.class)
@ResId(id="lin_core_wheel_totalwheelview")
public class TotalWheelView extends ResView implements OnWheelChangedListener {
    ...
    @ViewById(id="lin_core_totalwheel_province")
    private WheelView mProvince;
    @ViewById(id="lin_core_totalwheel_city")
    private WheelView mCity;
    @ViewById(id="lin_core_totalwheel_area")
