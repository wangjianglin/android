...
//            } else {
//                callback.onHanlderFailure(requestCode, context.getString(R.string.lin_core_grallery_photo_list_empty));
//            }
//        }
...
//            String errormsg = activity.getString(R.string.lin_core_grallery_empty_sdcard);
...
//        String errormsg = context.getString(R.string.lin_core_grallery_take_photo_fail);
//        if (mTakePhotoAction) {
//            resultFailure(errormsg, true);
//        } else {
