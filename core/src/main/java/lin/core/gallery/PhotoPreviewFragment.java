...
import lin.core.gallery.adapter.PhotoPreviewAdapter;
import lin.core.gallery.model.PhotoInfo;
import lin.core.gallery.widget.GFViewPager;
 ...
 */
@ResCls(R.class)
@ResId(id="lin_core_gallery_activity_photo_preview")
...
//    private TextView mTvIndicator;
    ...
    @ViewById(id="lin_core_gallery_preview_pager_pager")
...
//
//        mVpPager = (GFViewPager) findViewById(R.id.lin_core_gallery_preview_pager_pager);
//    }
