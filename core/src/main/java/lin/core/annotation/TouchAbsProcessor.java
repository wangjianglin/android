 ...
 *
 */
public abstract class TouchAbsProcessor<T extends Annotation> extends AbstractMethodProcessor<T>{
	...
	final protected void processMethod(Object target, Method method, View itemView,T annot){
		...
		itemView.setOnTouchListener(new ViewOnTouchListener(target,method,clcikMethodParams,annot));
	}
	...
	private class ViewOnTouchListener implements OnTouchListener{
		...
		T annot;
		ViewOnTouchListener(Object view,Method method,Class<?>[] clcikMethodParams,T annot){
			this.view = view;
